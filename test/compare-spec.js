require([
  ...
  describe('Compare bonsai shapes', function(){
    ...
    it('should create two different bonsai shapes and compare their visual result', function() {
      var bsVariantAlt = {
        content: function() {
          stage.addChild(bonsai.Shape.rect(0.5, 0.5, 110, 110).attr({fillColor:'blue'}));
        },
        delay: 2000
      };
    ...
    it('compares blending of a bikshed movie and svg', function() {
      var blendBs = {
        content: function(stage) {
          stage.addChild(Shape.rect(10, 10, 60, 60).attr({
            fillColor: '#00ff00',
            opacity: 0.5,
            lineColor: 0x00000000
          }));

          stage.addChild(Shape.rect(30, 30, 60, 60).attr({
            fillColor: '#ff0000',
            opacity: 0.5,
            lineColor: 0x00000000
          }));

          stage.addChild(Shape.rect(50, 50, 60, 60).attr({
            fillColor: '#0000ff',
            opacity: 0.5,
            lineColor: 0x00000000
          }));
