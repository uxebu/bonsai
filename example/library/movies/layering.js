...
var shape1 = new bonsai.Shape.rect(0, 0, 100, 100).attr({fillColor: 'red'});
var shape2 = new bonsai.Shape.rect(25,25, 100, 100).attr({fillColor: 'green'});
var shape3 = new bonsai.Shape.rect(50, 50, 100, 100).attr({fillColor: 'yellow'});
