...
// full circle
stage.addChild(bonsai.Path.circle(52, 52, 50).attr({fillColor: 'red', strokeWidth:1, strokeColor: 'yellow'}));
...
// half circle
stage.addChild(new bonsai.Path('M40,140 L40,100 L10,100 C10,10 90,10 90,100 L60,100 L60,140 M140,50 C70,180 195,180 190,100 z').attr({fillColor: 'blue', strokeWidth: 1}));
